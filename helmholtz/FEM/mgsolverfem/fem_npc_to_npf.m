...
%         requirements
%
% Use:  [npf,lev] = npc_to_npf(npc,k,ppw)
%
% Input
%       npc : number of points on coarsest grid (only interior points)
...
%       l   : number of levels (grids) including coarsest and finest grids
%
