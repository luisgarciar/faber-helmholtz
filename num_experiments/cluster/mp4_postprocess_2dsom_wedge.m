...
% Computation: mp4_cluster_2dsom_wedge
% Postprocessing: this file

load('mp4_results_cluster')
...
tableCaption = strcat('Model problem 4: Number of GMRES iterations, matrix-vector products and timings, computing the shifted Laplacian with a multigrid cycle.');
